/**
 * Spike Removal Filter using Rolling Mean + Standard Deviation
 * 
 * This utility detects and removes spikes in sensor data using a sliding window
 * approach with statistical outlier detection.
 */
 ...
 */
export function getSpikeStats(filteredData: FilteredDataPoint[]) {
  const stats = {
